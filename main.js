...
tools.compressor = {
    ui: `
        <div id="ui-content" style="width: 100%; max-width: 1000px; display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; margin: 0 auto;">
            <div class="card" style="background-color: var(--panel-bg); border-radius: 12px; padding: 1.25rem; box-shadow: 0 4px 12px var(--shadow-color); display: flex; flex-direction: column; gap: 0.75rem;">
                <h2>Draco Compression</h2>
                <p style="font-size: 0.9rem; text-align: center; color: #636366;">This tool will be available soon.</p>
                <button class="btn" disabled style="display: block; width: 100%; padding: 0.8rem; border: none; border-radius: 8px; font-size: 0.9rem; font-weight: 600; text-align: center; cursor: not-allowed; transition: all 0.2s ease; background-color: #e9e9eb; color: #8e8e93; opacity: 0.7;">Compress with Draco</button>
            </div>
        </div>
    `,
    init: () => {}
